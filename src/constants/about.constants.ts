...
export const ABOUT_HERO = {
  ...
  supporting:
    "We turn the sky into the most powerful storytelling canvas on Earth.",
} as const;
...
export const ABOUT_WHO_WE_ARE = {
  ...
  founderNote:
    "Founded and led by a team of technology and entertainment professionals committed to putting Africa on the global aerial entertainment map.",
} as const;
...
export const ABOUT_APPROACH_ITEMS: ApproachItem[] = [
  {
    ...
    description:
      "Advanced swarm systems with precision control and intelligent formation programming.",
  },
  {
    title: "Creative Storytelling",
    description:
      "Turning ideas into emotional sky narratives that audiences connect with and share.",
  },
  {
    title: "Precision Engineering",
    description:
      "Millimeter-accurate execution and absolute reliability from rehearsal to live show.",
  },
  {
    title: "Strategic Insight",
    description:
      "Campaigns designed to achieve real business and brand objectives, not just visual spectacle.",
  },
];
...
export const ABOUT_APPROACH_META = {
  ...
  closing:
    "From concept development to final execution and content delivery, we provide a complete turnkey experience tailored to each client's unique goals.",
} as const;
...
export const ABOUT_TESTIMONIALS = {
  ...
  items: [
    {
      quote:
        "The aerial display at our product launch was unlike anything our guests had ever experienced. The precision, the creativity, and the sheer scale of it left everyone speechless. Sky Concert Worldwide delivered something truly world-class.",
      name: "Adaeze Okonkwo",
    ...
    {
      quote:
        "We needed something that would define our national celebration and set a new benchmark for event entertainment in Nigeria. Sky Concert Worldwide exceeded every expectation. The coordination was flawless and the visual storytelling was deeply moving.",
      name: "Emeka Nwosu",
    ...
    {
      quote:
        "From the initial brief to the final execution, the professionalism of the Sky Concert team was outstanding. They understood our brand story and translated it into a sky experience that drove massive social media coverage for three days straight.",
      name: "Tunde Adeyemi",
...
export const ABOUT_CTA = {
  ...
  subheadline:
    "Let us bring your vision to life with a custom aerial experience designed around your goals.",
