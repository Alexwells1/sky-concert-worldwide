    ...
    <>
      <style>{`
        ...
        .cta-divider-line {
          width: 1px;
          height: 5rem;
          background: linear-gradient(to bottom, transparent, rgba(var(--foreground-rgb), 0.12), transparent);
          margin: 0 auto 4rem;
        }
        .cta-eyebrow {
        ...
        .cta-primary {
          ...
          background: rgba(var(--foreground-rgb), 0.94);
          color: var(--color-surface-11);
          font-family: 'DM Sans', sans-serif;
          font-weight: 400;
          font-size: 0.78rem;
        ...
        .cta-secondary:hover {
          ...
          border-color: rgba(var(--foreground-rgb), 0.32);
        }
      `}</style>
        ...
        >
          ...
          <div className="cta-buttons">
            <Link to="/contact" className="cta-primary">
              Book a Show <ArrowRight size={13} />
            </Link>
          </div>
        </div>
      </section>
