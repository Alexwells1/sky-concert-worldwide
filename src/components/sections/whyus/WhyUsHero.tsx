...
export default function WhyUsHero() {
  ...
  useEffect(() => {
    ...
    // Sparse star field
    type Star = { x: number; y: number; size: number; flicker: number; speed: number };
    const stars: Star[] = [];
    for (let i = 0; i < 120; i++) {
      stars.push({
        x: Math.random() * w,
  ...
  return (
    <section style={{
      ...
      <div style={{
        ...
        background: 'linear-gradient(145deg, #010610 0%, #030B1A 45%, #05091A 75%, #010610 100%)',
      }} />
      ...
      <div style={{
        ...
        <div style={{ maxWidth: '750px' }}>
          ...
          <h1 style={{
            ...
            <span style={{ color: 'white', display: 'block' }}>Because Your</span>
            <span style={{ color: 'white', display: 'block' }}>Event Deserves</span>
            <span style={{
              display: 'block',
          ...
          <p style={{
            ...
            In a world where attention is hard to capture, we give you an unfair advantage — the sky itself.
          </p>
