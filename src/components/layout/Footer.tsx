      ...
      <div style={{ maxWidth: '80rem', margin: '0 auto' }}>
        ...
        <div style={{
          ...
          <div>
            ...
            <p style={{ color: '#666', fontSize: '0.85rem', lineHeight: 1.8, marginBottom: '1.5rem' }}>
              info@skyconcertworldwide.com
            </p>
            <Link
              to="/contact"
              className="btn-primary"
              style={{ padding: '0.75rem 1.5rem', fontSize: '0.6rem', display: 'inline-flex' }}
            >
              Get In Touch
            </Link>
          </div>
